...
<section>
    <div class="home-slider mobile-banner">
        <div class="slider-itom">
            <img src="assets/images/slider4.png" class="w-100">
            <div class="container">
                <div class="koolconsole-home-info">
                    <div class="sm-title mb-2">
                        We Are IT Creative

                    </div>
                    <div class="xl-title">
                        Best Software Development Company For Your Business
                    </div>
                    <div class="koolconsole-title mt-2 mb-4">
                        Highly tailored in Website Development, Mobile App development, Desktop Application Development, Game Development, CRM Development, ERP Development....
                    </div>
                    <button class="btn  btn-outline-secondary custom-btn"> View More</button>
                </div>
            </div>
        </div>
        <div class="slider-itom">
            <img src="assets/images/slider3.png" class="w-100">
            <div class="container">
                <div class="koolconsole-home-info">
                    <div class="sm-title mb-2">
                        We Are IT Solution
                    ...
                    <div class="xl-title">
                        Best IT Agency & Service For Digital Security, Digital Marketing, Search Engine Optimisation.... 
                    </div>
                    <div class="koolconsole-title mt-2 mb-4">
        ...
        <div class="slider-itom">
            <img src="assets/images/slider2.png" class="w-100">
            <div class="container">
                <div class="koolconsole-home-info">
                    <div class="sm-title mb-2">
                    ...
                    <div class="koolconsole-title mt-2 mb-4">
                        We are mastering in CRM Development, ERM Development, GAME Development, Ecommerce ,Social Media....
                    </div>
                    <button class="btn  btn-outline-secondary custom-btn"> View More</button>
                </div>
            </div>
...
<section>
    <div class="kool-our-process pt-3 koolbg border pb-3">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 pt-3">
                    <div class="sm-title">
                        Our<span class="title-gray"> Process</span>

                    </div>
                    <div class="md-title mt-2 mb-2">
                        Preparing For Your<br> Success
                    </div>
                    <p class="xs-title mt-4">
                        Our company developer and designers are highly skilled at designing a website that will match your company branding and enhance your presence on the web. We will create an effective website of help to you
                        generate new customers than improve traffic and Grow to your online business
                    </p>
                    <img src="assets/images/element2.png" class="w-25 hide-m">
                </div>
                <div class="col-lg-6 col-md-6 col-sm-12">

                    <div class="kool-work-proces pt-3">
                        <img src="assets/images/koolconsoleidea.svg">
                    </div>
                </div>
            </div>
        </div>
